			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				...
				<div className="grid lg:grid-cols-2 gap-12 items-center">
					...
					>
						<div>
							...
							<p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-6">
								...
								over 5 years of experience creating innovative digital
								solutions. I believe in the power of technology to transform
								ideas into impactful experiences that make a difference in
								people&apos;s lives.
							</p>
							<p className="text-gray-600 dark:text-gray-300 leading-relaxed">
								My approach combines technical expertise with creative
								problem-solving, ensuring that every project I work on is not
								only functional but also beautiful and user-friendly. I&apos;m
					...
					>
						...
						<div className="relative">
							...
							{/* Decorative elements */}
							<div className="absolute -top-4 -right-4 w-20 h-20 bg-yellow-400 dark:bg-yellow-500 rounded-full opacity-20"></div>
							<div className="absolute -bottom-4 -left-4 w-16 h-16 bg-pink-400 dark:bg-pink-500 rounded-full opacity-20"></div>
						</div>
				...
				>
					<div className="text-center p-6 bg-gray-50 dark:bg-gray-800 rounded-xl">
						...
						<p className="text-gray-600 dark:text-gray-300">
							Recognized for excellence in web development and design
							innovation.
						</p>
					</div>
					...
					<div className="text-center p-6 bg-gray-50 dark:bg-gray-800 rounded-xl">
						...
						<p className="text-gray-600 dark:text-gray-300">
							Collaborative approach with strong communication and leadership
							skills.
						</p>
					</div>
					...
					<div className="text-center p-6 bg-gray-50 dark:bg-gray-800 rounded-xl">
						...
						<p className="text-gray-600 dark:text-gray-300">
							Continuously updating skills and staying current with industry
							trends.
						</p>
					</div>
				</motion.div>
