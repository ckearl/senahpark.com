...
const Projects = () => {
	const projects = [
		...
		},
		{
			...
			description:
				"An intelligent chatbot powered by machine learning, featuring natural language processing and contextual responses.",
			image: "/api/placeholder/400/250",
		...
		},
		{
			...
			description:
				"A beautiful weather application with real-time data, interactive maps, and detailed forecasting capabilities.",
			image: "/api/placeholder/400/250",
		...
		},
		{
			...
			description:
				"A comprehensive inventory management solution for businesses, featuring barcode scanning, reporting, and analytics.",
			image: "/api/placeholder/400/250",
				...
				<div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
					{projects.map((project, index) => (
						<motion.div
							...
							viewport={{ once: true }}
							className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-xl dark:shadow-gray-700/25 dark:hover:shadow-gray-700/40 transition-all duration-300 overflow-hidden group"
						>
							{/* Project Image */}
								...
								<div className="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-50 transition-all duration-300 flex items-center justify-center">
									<div className="opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex gap-4">
										<motion.a
											...
											className="w-12 h-12 bg-white dark:bg-gray-800 rounded-full flex items-center justify-center hover:bg-blue-50 dark:hover:bg-gray-700 transition-colors duration-200"
										>
											<ExternalLink
							...
							<div className="p-6">
								...
								<div className="flex gap-3">
									...
									<motion.a
										...
										whileTap={{ scale: 0.95 }}
										href={project.githubUrl}
										className="flex-1 flex items-center justify-center gap-2 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 py-2 px-4 rounded-lg text-sm font-medium hover:border-blue-600 dark:hover:border-blue-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-200"
									>
										<Github size={16} />
										Code
									</motion.a>
